...
public class Coffeeshop {
    ...
    public static void main(String[] args) {
        ...
        // Add users (employees and administrators)
        system.addUser(new User("Farhan", "024222", UserRole.ADMINISTRATOR));
        system.addUser(new User("employee2", "password2", UserRole.EMPLOYEE));
